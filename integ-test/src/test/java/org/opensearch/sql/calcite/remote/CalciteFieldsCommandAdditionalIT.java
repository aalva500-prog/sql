 ...
 * using the Calcite engine. Extends {@link FieldsCommandAdditionalIT} to run the same tests
 * with Calcite enabled.
 * 
 * <p>This class enables the Calcite query engine and disallows fallback to ensure all tests
 * are executed using the Calcite engine. It inherits all test methods from the parent class
 * {@link FieldsCommandAdditionalIT}.
 * 
...
public class CalciteFieldsCommandAdditionalIT extends FieldsCommandAdditionalIT {
  ...
  /**
   * Override the test for non-existent fields in Calcite mode.
   * Calcite throws a different exception for non-existent fields.
   */
  @Override
  ...
  /**
   * Override the test for mix of existing and non-existent fields in Calcite mode.
   * Calcite throws a different exception for non-existent fields.
   */
  @Override
  ...
  /**
   * Override the test for excluding non-existent fields in Calcite mode.
   * Calcite throws a different exception for non-existent fields.
   */
  @Override
